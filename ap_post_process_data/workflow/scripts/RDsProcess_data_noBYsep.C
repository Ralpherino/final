...
void RDsProcess_data_noBYsep(TString ntuple_filename, TString output_filename) {
    ...
    BsSignalCUT c{ntuple_filename, "", output_filename, inclMCmode, 10000.0, BDT_Iso_cut};
    c.Loop();
}
